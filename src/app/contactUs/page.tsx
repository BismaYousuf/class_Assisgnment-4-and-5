...
function Contact() {
  return (
    <div className="p-4 sm:p-6 font-sans">
      {/* Contact Us Heading */}
      <h1 className="text-3xl sm:text-4xl text-black text-center mt-10 font-bold">Contact Us</h1>
      ...
      <div className="mt-5 text-center text-base sm:text-lg">
        <h2 className="text-2xl sm:text-3xl text-black text-center font-bold mb-5">Contact Information</h2>
      ...
      <div className="mt-10 text-base sm:text-lg">
        <h2 className="text-2xl sm:text-2xl text-black text-center">Send Us a Message</h2>
        <form className="max-w-lg mx-auto mt-4">
          ...
          <button type="submit" className="bg-black text-white py-2 px-4 rounded mt-4 hover:bg-slate-300">
            Submit
          </button>
        </form>
      </div>
      ...
      <div className="mt-10 text-center text-base sm:text-lg">
        <h2 className="text-2xl sm:text-3xl text-black font-bold">Follow Us on Social Media</h2>
