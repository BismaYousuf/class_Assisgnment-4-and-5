...
function SingleCard(props: { item: { id: number; src: string; heading: string; para: string } }) {
  return (
    <div className="w-full max-w-xs sm:max-w-sm md:max-w-xs lg:max-w-xs h-auto bg-white text-black mx-2 mb-6 border-2 rounded-lg border-black p-3 shadow-2xl transition-transform transform hover:scale-105 hover:shadow-sm">
